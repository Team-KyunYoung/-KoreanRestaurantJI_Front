    ...
    return (
      <div className={styles.searchItem}>
        ...
        <button
          ...
          onClick={() => deleteRoomBtn(roomNumber)}
        >
          삭제
        </button>
      </div>
                  ...
                  <div className={styles.roomInput}>
                    <label className={styles.inputLabel}>
                      ...
                      <input
                        ...
                        value={createRoomInput.roomName}
                      />
                    </label>
                    <label className={styles.inputLabel}>
                      객실 사진 url{" "}
                ...
                <div className={styles.deleteSearch}>
                  <div className={styles.searchInput}>
                    <label className={styles.searchLabel}>
                      ...
                      <input
                        name="searchName"
                        onChange={handleSearchRoomInput}
                        value={searchRoomInput}
                      />
                    </label>
                    <button
                      className={styles.searchBtn}
                      onClick={searchRoomBtn}
                    >
                      검색
                    </button>
                  </div>
                  ...
                  <div className={styles.searchList}>
                    {isLoading ? null : searchRoomList.length === 0 ? (
