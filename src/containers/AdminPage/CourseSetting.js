...
const CourseSetting = () => {
  ...
  const handleSearchCourseInput = (e) => {
    ...
    return (
      <div className={styles.searchItem}>
        ...
        <button
          ...
          onClick={() => deleteCourseBtn(courseNumber)}
        >
          삭제
        </button>
      </div>
                ...
                <div className={styles.createInput}>
                  <div className={styles.courseInput}>
                    <label className={styles.inputLabel}>
                      ...
                      <input
                        name="courseName"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.CourseName}
                      />
                    </label>
                    <label className={styles.inputLabel}>
                      코스 가격{" "}
                      <input
                        name="coursePrice"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.CoursePrice}
                        placeholder="숫자만 입력"
                      />
                    </label>
                    <label className={styles.inputLabel}>
                      ...
                      <select
                        name="appetizer"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.appetizer}
                      >
                        {isLoading ? null : appetizerDishs.length === 0 ? (
                          <option>해당 요리 없음</option>
                        ) : (
                    ...
                    <label className={styles.inputLabel}>
                      ...
                      <select
                        name="entree1"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.entree1}
                      >
                        {isLoading ? null : entreeDishs.length === 0 ? (
                          <option>해당 요리 없음</option>
                        ) : (
                    ...
                    <label className={styles.inputLabel}>
                      ...
                      <select
                        name="entree2"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.entree2}
                      >
                        {isLoading ? null : entreeDishs.length === 0 ? (
                          <option>해당 요리 없음</option>
                        ) : (
                    ...
                    <label className={styles.inputLabel}>
                      ...
                      <select
                        name="entree3"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.entree3}
                      >
                        {isLoading ? null : entreeDishs.length === 0 ? (
                          <option>해당 요리 없음</option>
                        ) : (
                    ...
                    <label className={styles.inputLabel}>
                      ...
                      <select
                        name="dessert"
                        onChange={handleCreateCourseInput}
                        value={createCourseInput.dessert}
                      >
                        {isLoading ? null : dessertDishs.length === 0 ? (
                          <option>해당 요리 없음</option>
                        ) : (
                ...
                <div className={styles.deleteSearch}>
                  <div className={styles.searchInput}>
                    <label className={styles.searchLabel}>
                      ...
                      <input
                        name="searchName"
                        onChange={handleSearchCourseInput}
                        value={searchCourseInput}
                      />
                    </label>
                    <button
                      className={styles.searchBtn}
                      onClick={searchCourseBtn}
                    >
                      검색
                    </button>
                  </div>
                  ...
                  <div className={styles.searchList}>
                    {isSearchLoading ? null : searchCourseList.length === 0 ? (
