    ...
    <div>
      <div>
        ...
        <p className="ls2">
          ...
          <em className="emphasis">10</em>월 <em className="emphasis">1</em>부터
          적용됩니다.
        </p>
        <br />
        <p className="lh6 bs4">
        ...
        <div className="list_indent2 mgt10">
          ...
          <p className="ls2">
            이벤트 및 광고성 정보 제공 및 참여기회 제공 등을 목적으로 개인정보를
            처리합니다.
          </p>
          <br />
        </div>
        ...
        <p className="lh6 bs4">
          ...
          <br />①<em className="emphasis">&lt;JI&gt;</em>
        ...
        <p className="lh6 bs4">
          ...
          <br />
          <br /> ① <em className="emphasis">&lt;JI&gt;</em>은(는) 다음의
          개인정보 항목을 처리하고 있습니다.
        </p>
        <ul className="list_indent2 mgt10">
          <li className="tt">1&lt;홈페이지 회원가입 및 관리&gt;</li>
        ...
        <p className="lh6 bs4">
          ...
          <br />①{" "}
          <em className="emphasis">
            &lt;JI&gt;은(는) 개인정보를 제1조(개인정보의 처리 목적)에서 명시한
        ...
        <p className="sub_p mgt10">
          ② <span className="colorLightBlue">&lt;JI&gt;</span>은(는) 다음과 같이
        ...
        <p className="lh6 bs4">
          ...
          <br />
          <br /> ① <em className="emphasis">&lt;JI&gt;</em>은(는) 원활한
          개인정보 업무처리를 위하여 다음과 같이 개인정보 처리업무를 위탁하고
          있습니다.
        </p>
        <ul className="list_indent2 mgt10">
          <li className="tt">1. </li>
        ...
        <p className="sub_p mgt10">
          ②<span className="colorLightBlue">&lt;JI&gt;</span>은(는) 위탁계약
        ...
        <p className="ls2">
          <br />① &lt;JI&gt;은(는) 개인정보 보유기간의 경과, 처리목적 달성 등
          ...
          <br />
          1. 파기절차
          <br /> &lt;JI&gt; 은(는) 파기 사유가 발생한 개인정보를 선정하고,
          &lt;JI&gt; 의 개인정보 보호책임자의 승인을 받아 개인정보를 파기합니다.
          <br />
        </p>
        ...
        <p className="ls2">
          <br />
          <br />① 정보주체는 JI에 대해 언제든지 개인정보 열람·정정·삭제·처리정지
          요구 등의 권리를 행사할 수 있습니다.
        </p>
        <p className="sub_p">
          ② 제1항에 따른 권리 행사는JI에 대해 「개인정보 보호법」 시행령
          제41조제1항에 따라 서면, 전자우편, 모사전송(FAX) 등을 통하여 하실 수
          있으며 JI은(는) 이에 대해 지체 없이 조치하겠습니다.
        </p>
        <p className="sub_p">
        ...
        <p className="sub_p">
          ⑥ JI은(는) 정보주체 권리에 따른 열람의 요구, 정정·삭제의 요구,
        ...
        <div className="sub_p mgt10">
          ...
          <div className="ls2">
            <br />
            <br />
            JI 은(는) 정보주체의 이용정보를 저장하고 수시로 불러오는
            ...
            <p className="sub_p mgt10">
              {" "}
              ①<span className="colorLightBlue">JI</span> 은(는) 개인정보 처리에
            ...
            <p className="sub_p">
              ② 정보주체께서는 JI 의 서비스(또는 사업)을 이용하시면서 발생한
              모든 개인정보 보호 관련 문의, 불만처리, 피해구제 등에 관한 사항을
              개인정보 보호책임자 및 담당부서로 문의하실 수 있습니다. JI 은(는)
            ...
            <p className="lh6 bs4">
              <strong>
                제14조(국내대리인의 지정)<em className="emphasis"></em>
              </strong>
              <br />
              <br />
              정보주체는 ｢개인정보 보호법｣ 제39조의11에 따라 지정된 &lt;JI&gt;의
              국내대리인에게 개인정보 관련 고충처리 등의 업무를 위하여 연락을
              취할 수 있습니다.&lt;JI&gt;은(는) 정보주체의 개인정보 관련
              고충처리 등 개인정보 보호책임자의 업무 등을 신속하게 처리할 수
              있도록 노력하겠습니다. <br />
              <br />▶ &lt;JI&gt;은(는) ｢개인정보 보호법｣ 제39조의11에 따라
              국내대리인을 지정하였습니다.
            </p>
            <p className="sub_p"></p>
            <p className="sub_p"></p>
        ...
        <p className="lh6 bs4">
          <strong>
            ...
            <br />① <em className="emphasis">&lt;JI&gt;</em>은(는) 아래와 같이
            영상정보처리기기를 설치·운영하고 있습니다.
          </strong>
        </p>
        <p className="sub_p mgt30">
          1.영상정보처리기기 설치근거·목적 :{" "}
          <span className="colorLightBlue">&lt;JI&gt;</span>의{" "}
        </p>
        <ul className="list_indent2 mgt10">
        ...
        <p className="lh6 bs4">
          <strong>
            제18조(개인정보 처리방침 변경)<em className="emphasis"></em>
          </strong>
        </p>
        <br />
      </div>
