...
function ToLink(data) {
  ...
  return (
    <div className={styles.link_button}>
      <Link to={data.link}>해당 페이지로 이동하기</Link>
    </div>
  );
}
const config = {
...
const steps = [
  ...
  },
  {
    id: "Order",
    message:
      " 아래 버튼을 클릭하면 주문 페이지로 이동합니다. 이곳에서 주문을 완료해주세요.",
    trigger: "Order-link",
  },
  {
    id: "Order-link",
  ...
  },
  {
    id: "Reservation2",
    message:
      " 룸을 선택해 주시고, 필요한 정보를 입력 후 원하는 시간대를 선택하여 예약하시면 됩니다.",
  ...
  },
  {
    id: "Map",
    message:
      " 아래 링크에서 식당의 정확한 위치정보를 네이버 지도로 확인하실 수 있습니다.",
    trigger: "Map-link",
  },
  {
    id: "Map-link",
    ...
    options: [
      {
        value: 1,
        label: "방문 포장 주문 확인",
        trigger: "UserInfo-Order-link",
      },
      {
        value: 2,
        label: "식당 좌석 예약 확인",
        trigger: "UserInfo-Reservation-link",
      },
    ],
  },
  {
  ...
  },
  {
    id: "etc",
    message:
      " 그 밖의 문의 사항은 FAQ를 확인해 주시고, 관련 문의 사항이 없다면 QNA 페이지에 문의 남겨주세요.",
    trigger: "etc-Select",
  },
  {
    id: "etc-Select",
  ...
  },
  {
    ...
    options: [{ value: 1, label: "더 질문하기", trigger: "2" }],
  },
];
    ...
    <ThemeProvider theme={theme}>
      <ChatBot
        ...
        bubbleOptionStyle={{
          ...
          hover: { backgroundColor: "#424566", color: "#fff" },
        }} //hover 적용 안됨. 하는 법 모르겠음
        customStyle={{
          width: "250px",
          border: "2px solid #424566",
